...
import { StyleSheet, Image, Modal, Text, View, Pressable, ScrollView, ImageBackground, } from "react-native";
...
const destination = {latitude: sortedMarkers[sortedMarkers.length-1].latitude, longitude: sortedMarkers[sortedMarkers.length-1].longitude};
